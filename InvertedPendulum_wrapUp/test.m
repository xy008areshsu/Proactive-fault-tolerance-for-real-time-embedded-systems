...
for angle_noise1 = angles_noise1
    for angle_noise2 = angles_noise2
        for rate_noise1 = rates_noise1
            for rate_noise2 = rates_noise2
                R = [angle_noise1 0; 0 rate_noise1];
                R2 = [angle_noise2 0; 0 rate_noise2];
                ...
                for i = 1 : size(time, 2) - 1
                    ...
                    %predict
                    [x_predict, P] = kalman_predict(x_track(:, i), P, u);
                    
                    %update
                    [x_predict, P] = kalman_update(x_predict, P, R, Z);
                ...
                plot(time, x_track(4, :), 'g', 'LineWidth', 1);
%                 plot(time, measurements, 'g', 'LineWidth', 1);
%                 plot(time, measurements2, 'k', 'LineWidth', 1);
                legend('True angle rate', 'Predicted angle rate')
                xlabel('time (s)')
                title('Two sensors')
