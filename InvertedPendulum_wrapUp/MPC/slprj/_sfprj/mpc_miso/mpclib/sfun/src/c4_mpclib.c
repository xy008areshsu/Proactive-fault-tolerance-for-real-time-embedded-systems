...
static void initialize_params_c4_mpclib(SFc4_mpclibInstanceStruct *chartInstance)
{
  ...
  sf_mex_import_named("v_temp", sf_mex_get_sfun_param(chartInstance->S, 8, 0),
                      c4_dv0, 0, 0, 0U, 1, 0U, 1, 22);
  for (c4_i0 = 0; c4_i0 < 22; c4_i0++) {
  ...
  *chartInstance)
{
  ...
  c4_e_y = NULL;
  sf_mex_assign(&c4_e_y, sf_mex_create("y", c4_d_u, 0, 0U, 1U, 0U, 1, 22), FALSE);
...
static void sf_c4_mpclib(SFc4_mpclibInstanceStruct *chartInstance)
{
  ...
  real_T c4_b_no_ref;
  int32_T c4_i15;
  real_T c4_b_v_temp[22];
  int32_T c4_i16;
  real_T c4_b_r_temp[10];
  int32_T c4_i17;
  ...
  for (c4_i18 = 0; c4_i18 < 22; c4_i18++) {
    c4_j_u[c4_i18] = c4_b_v_temp[c4_i18];
  }

  c4_j_y = NULL;
  sf_mex_assign(&c4_j_y, sf_mex_create("y", c4_j_u, 0, 0U, 1U, 0U, 1, 22), FALSE);
  for (c4_i19 = 0; c4_i19 < 10; c4_i19++) {
    c4_k_u[c4_i19] = c4_b_r_temp[c4_i19];
  }

  c4_k_y = NULL;
  sf_mex_assign(&c4_k_y, sf_mex_create("y", c4_k_u, 0, 0U, 1U, 0U, 1, 10), FALSE);
  ...
  *c4_inData)
{
  ...
  chartInstance = (SFc4_mpclibInstanceStruct *)chartInstanceVoid;
  c4_mxArrayOutData = NULL;
  for (c4_i30 = 0; c4_i30 < 22; c4_i30++) {
    c4_b_inData[c4_i30] = (*(real_T (*)[22])c4_inData)[c4_i30];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i32 = 0; c4_i32 < 22; c4_i32++) {
    (*(real_T (*)[22])c4_outData)[c4_i32] = c4_y[c4_i32];
  }
  ...
  *c4_inData)
{
  ...
  for (c4_i33 = 0; c4_i33 < 10; c4_i33++) {
    c4_b_inData[c4_i33] = (*(real_T (*)[10])c4_inData)[c4_i33];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i35 = 0; c4_i35 < 10; c4_i35++) {
    (*(real_T (*)[10])c4_outData)[c4_i35] = c4_y[c4_i35];
  }
  ...
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[10])
{
  real_T c4_dv9[10];
  int32_T c4_i36;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv9, 1, 0, 0U, 1, 0U, 1, 10);
  for (c4_i36 = 0; c4_i36 < 10; c4_i36++) {
  ...
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[22])
{
  real_T c4_dv10[22];
  int32_T c4_i37;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv10, 1, 0, 0U, 1, 0U, 1, 22);
  for (c4_i37 = 0; c4_i37 < 22; c4_i37++) {
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2759360646U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(519368083U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2841564499U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3536713083U);
}
...
mxArray *sf_c4_mpclib_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("X9RmM4tzFlnTKn7xocc1qF");
...
static void mdlSetWorkWidths_c4_mpclib(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1858154996U));
  ssSetChecksum1(S,(4256584304U));
  ssSetChecksum2(S,(287541796U));
  ssSetChecksum3(S,(3294761322U));
