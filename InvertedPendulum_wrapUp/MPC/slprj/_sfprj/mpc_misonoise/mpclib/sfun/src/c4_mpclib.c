...
static void registerMessagesc4_mpclib(SFc4_mpclibInstanceStruct *chartInstance);
...
static real_T c4_h_emlrt_marshallIn(SFc4_mpclibInstanceStruct *chartInstance,
  const mxArray *c4_next_t, const char_T *c4_identifier);
static real_T c4_i_emlrt_marshallIn(SFc4_mpclibInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static const mxArray *c4_f_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_j_emlrt_marshallIn(SFc4_mpclibInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static uint8_T c4_l_emlrt_marshallIn(SFc4_mpclibInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static void initialize_params_c4_mpclib(SFc4_mpclibInstanceStruct *chartInstance)
{
  ...
  sf_mex_import_named("v_temp", sf_mex_get_sfun_param(chartInstance->S, 8, 0),
                      c4_dv0, 0, 0, 0U, 1, 0U, 1, 82);
  for (c4_i0 = 0; c4_i0 < 82; c4_i0++) {
  ...
  sf_mex_import_named("md_temp", sf_mex_get_sfun_param(chartInstance->S, 0, 0),
                      c4_dv2, 0, 0, 0U, 1, 0U, 1, 2);
  for (c4_i2 = 0; c4_i2 < 2; c4_i2++) {
    chartInstance->c4_md_temp[c4_i2] = c4_dv2[c4_i2];
  }
  ...
  sf_mex_import_named("sf_mex_get_sfun_param", sf_mex_get_sfun_param
                      (chartInstance->S, 5, 0), &c4_d7, 0, 0, 0U, 0, 0U, 0);
  ...
  *chartInstance)
{
  ...
  for (c4_i3 = 0; c4_i3 < 40; c4_i3++) {
    c4_b_u[c4_i3] = (*c4_rseq)[c4_i3];
  }

  c4_c_y = NULL;
  sf_mex_assign(&c4_c_y, sf_mex_create("y", c4_b_u, 0, 0U, 1U, 0U, 1, 40), FALSE);
  sf_mex_setcell(c4_y, 1, c4_c_y);
  for (c4_i4 = 0; c4_i4 < 2; c4_i4++) {
    c4_c_u[c4_i4] = (*c4_v)[c4_i4];
  }
  ...
  for (c4_i5 = 0; c4_i5 < 82; c4_i5++) {
    c4_d_u[c4_i5] = (*c4_vseq)[c4_i5];
  }

  c4_e_y = NULL;
  sf_mex_assign(&c4_e_y, sf_mex_create("y", c4_d_u, 0, 0U, 1U, 0U, 1, 82), FALSE);
  ...
  const mxArray *c4_st)
{
  ...
  *c4_next_t = c4_h_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c4_u, 0)), "next_t");
  c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 1)),
                        "rseq", c4_dv3);
  for (c4_i6 = 0; c4_i6 < 40; c4_i6++) {
    (*c4_rseq)[c4_i6] = c4_dv3[c4_i6];
  }

  c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 2)), "v",
                        c4_dv4);
  for (c4_i7 = 0; c4_i7 < 2; c4_i7++) {
    (*c4_v)[c4_i7] = c4_dv4[c4_i7];
  }

  c4_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 3)),
                        "vseq", c4_dv5);
  for (c4_i8 = 0; c4_i8 < 82; c4_i8++) {
    (*c4_vseq)[c4_i8] = c4_dv5[c4_i8];
  }

  chartInstance->c4_is_active_c4_mpclib = c4_k_emlrt_marshallIn(chartInstance,
...
static void sf_c4_mpclib(SFc4_mpclibInstanceStruct *chartInstance)
{
  ...
  real_T c4_b_no_ref;
  int32_T c4_i15;
  real_T c4_b_v_temp[82];
  int32_T c4_i16;
  real_T c4_b_r_temp[40];
  int32_T c4_i17;
  real_T c4_b_md_temp[2];
  real_T c4_time;
  ...
  for (c4_i9 = 0; c4_i9 < 40; c4_i9++) {
    _SFD_DATA_RANGE_CHECK((*c4_c_rseq)[c4_i9], 0U);
  }

  for (c4_i10 = 0; c4_i10 < 82; c4_i10++) {
    _SFD_DATA_RANGE_CHECK((*c4_c_vseq)[c4_i10], 1U);
  }

  _SFD_DATA_RANGE_CHECK(*c4_b_ref, 2U);
  _SFD_DATA_RANGE_CHECK(*c4_b_md, 3U);
  for (c4_i11 = 0; c4_i11 < 2; c4_i11++) {
    _SFD_DATA_RANGE_CHECK((*c4_c_v)[c4_i11], 4U);
  }
  ...
  for (c4_i12 = 0; c4_i12 < 82; c4_i12++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c4_v_temp[c4_i12], 12U);
  }

  for (c4_i13 = 0; c4_i13 < 40; c4_i13++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c4_r_temp[c4_i13], 13U);
  }

  for (c4_i14 = 0; c4_i14 < 2; c4_i14++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c4_md_temp[c4_i14], 14U);
  }
  ...
  c4_j_hoistedGlobal = *c4_b_time;
  c4_k_hoistedGlobal = chartInstance->c4_openloopflag;
  ...
  for (c4_i15 = 0; c4_i15 < 82; c4_i15++) {
    c4_b_v_temp[c4_i15] = chartInstance->c4_v_temp[c4_i15];
  }

  for (c4_i16 = 0; c4_i16 < 40; c4_i16++) {
    c4_b_r_temp[c4_i16] = chartInstance->c4_r_temp[c4_i16];
  }

  for (c4_i17 = 0; c4_i17 < 2; c4_i17++) {
    c4_b_md_temp[c4_i17] = chartInstance->c4_md_temp[c4_i17];
  }

  c4_time = c4_j_hoistedGlobal;
  c4_b_openloopflag = c4_k_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 1U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_ref, 2U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_md, 3U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_nv, 4U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_ny, 5U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_p, 6U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_yoff, 7U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_voff, 8U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_no_md, 9U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_no_ref, 10U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_b_v_temp, 11U, c4_c_sf_marshallOut,
    c4_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_b_r_temp, 12U, c4_d_sf_marshallOut,
    c4_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_b_md_temp, 13U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_time, 14U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_openloopflag, 15U,
    c4_e_sf_marshallOut, c4_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_rseq, 16U, c4_d_sf_marshallOut,
    c4_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_vseq, 17U, c4_c_sf_marshallOut,
    c4_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_v, 18U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_next_t, 19U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c4_i18 = 0; c4_i18 < 82; c4_i18++) {
    c4_j_u[c4_i18] = c4_b_v_temp[c4_i18];
  }

  c4_j_y = NULL;
  sf_mex_assign(&c4_j_y, sf_mex_create("y", c4_j_u, 0, 0U, 1U, 0U, 1, 82), FALSE);
  for (c4_i19 = 0; c4_i19 < 40; c4_i19++) {
    c4_k_u[c4_i19] = c4_b_r_temp[c4_i19];
  }

  c4_k_y = NULL;
  sf_mex_assign(&c4_k_y, sf_mex_create("y", c4_k_u, 0, 0U, 1U, 0U, 1, 40), FALSE);
  for (c4_i20 = 0; c4_i20 < 2; c4_i20++) {
    c4_l_u[c4_i20] = c4_b_md_temp[c4_i20];
  }

  c4_l_y = NULL;
  sf_mex_assign(&c4_l_y, sf_mex_create("y", c4_l_u, 0, 0U, 1U, 0U, 1, 2), FALSE);
  c4_m_u = c4_time;
  c4_m_y = NULL;
  ...
  sf_mex_call_debug("mpcblock_refmd_mex", 4U, 14U, 14, c4_y, 14, c4_b_y, 14,
                    ...
                    c4_m_y, 14, c4_n_y, &c4_b_rseq, &c4_b_vseq, &c4_b_v,
                    &c4_b_next_t);
  c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_b_rseq), "rseq", c4_dv6);
  for (c4_i21 = 0; c4_i21 < 40; c4_i21++) {
    c4_rseq[c4_i21] = c4_dv6[c4_i21];
  }

  c4_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_b_vseq), "vseq", c4_dv7);
  for (c4_i22 = 0; c4_i22 < 82; c4_i22++) {
    c4_vseq[c4_i22] = c4_dv7[c4_i22];
  }

  c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_b_v), "v", c4_dv8);
  for (c4_i23 = 0; c4_i23 < 2; c4_i23++) {
    c4_v[c4_i23] = c4_dv8[c4_i23];
  }

  c4_next_t = c4_h_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_b_next_t),
    "next_t");
  ...
  for (c4_i24 = 0; c4_i24 < 40; c4_i24++) {
    (*c4_c_rseq)[c4_i24] = c4_rseq[c4_i24];
  }

  for (c4_i25 = 0; c4_i25 < 82; c4_i25++) {
    (*c4_c_vseq)[c4_i25] = c4_vseq[c4_i25];
  }

  for (c4_i26 = 0; c4_i26 < 2; c4_i26++) {
    (*c4_c_v)[c4_i26] = c4_v[c4_i26];
  }
...
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  const mxArray *c4_next_t;
  const char_T *c4_identifier;
  emlrtMsgIdentifier c4_thisId;
  real_T c4_y;
  SFc4_mpclibInstanceStruct *chartInstance;
  chartInstance = (SFc4_mpclibInstanceStruct *)chartInstanceVoid;
  c4_next_t = sf_mex_dup(c4_mxArrayInData);
  c4_identifier = c4_varName;
  c4_thisId.fIdentifier = c4_identifier;
  c4_thisId.fParent = NULL;
  c4_y = c4_i_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_next_t), &c4_thisId);
  sf_mex_destroy(&c4_next_t);
  ...
  *c4_inData)
{
  ...
  chartInstance = (SFc4_mpclibInstanceStruct *)chartInstanceVoid;
  c4_mxArrayOutData = NULL;
  for (c4_i30 = 0; c4_i30 < 82; c4_i30++) {
    c4_b_inData[c4_i30] = (*(real_T (*)[82])c4_inData)[c4_i30];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i32 = 0; c4_i32 < 82; c4_i32++) {
    (*(real_T (*)[82])c4_outData)[c4_i32] = c4_y[c4_i32];
  }
  ...
  *c4_inData)
{
  ...
  chartInstance = (SFc4_mpclibInstanceStruct *)chartInstanceVoid;
  c4_mxArrayOutData = NULL;
  for (c4_i33 = 0; c4_i33 < 40; c4_i33++) {
    c4_b_inData[c4_i33] = (*(real_T (*)[40])c4_inData)[c4_i33];
  }

  for (c4_i34 = 0; c4_i34 < 40; c4_i34++) {
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i35 = 0; c4_i35 < 40; c4_i35++) {
    (*(real_T (*)[40])c4_outData)[c4_i35] = c4_y[c4_i35];
  }
  ...
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[40])
{
  real_T c4_dv9[40];
  int32_T c4_i36;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv9, 1, 0, 0U, 1, 0U, 1, 40);
  for (c4_i36 = 0; c4_i36 < 40; c4_i36++) {
    c4_y[c4_i36] = c4_dv9[c4_i36];
  }
  ...
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[82])
{
  real_T c4_dv10[82];
  int32_T c4_i37;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv10, 1, 0, 0U, 1, 0U, 1, 82);
  for (c4_i37 = 0; c4_i37 < 82; c4_i37++) {
    c4_y[c4_i37] = c4_dv10[c4_i37];
  }
  ...
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[2])
{
  real_T c4_dv11[2];
  int32_T c4_i38;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv11, 1, 0, 0U, 1, 0U, 1, 2);
  for (c4_i38 = 0; c4_i38 < 2; c4_i38++) {
    c4_y[c4_i38] = c4_dv11[c4_i38];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4010735081U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3753526467U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3489578237U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(360808867U);
}
...
mxArray *sf_c4_mpclib_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("RT25e7SKx7FGyqpj6F7auH");
...
static void mdlSetWorkWidths_c4_mpclib(SimStruct *S)
{
   ...
   */
  const char_T *rtParamNames[] = { "md_temp", "no_md", "no_ref", "nv", "ny",
    "openloopflag", "p", "r_temp", "v_temp", "voff", "yoff" };
  ...
  ssSetChecksum0(S,(3245882517U));
  ssSetChecksum1(S,(3041672167U));
  ssSetChecksum2(S,(53655085U));
  ssSetChecksum3(S,(2365217356U));
