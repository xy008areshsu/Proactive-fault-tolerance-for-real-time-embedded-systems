...
csvwrite('./simResults/TAAF_Adaptive1.csv', taaf_adaptive1);
...
csvwrite('./simResults/TAAF_Adaptive2.csv', taaf_adaptive2);
...
csvwrite('./simResults/TAAF_Adaptive3.csv', taaf_adaptive1);
...
csvwrite('./simResults/TAAF_All_on.csv', taaf_all_on);
...
plot(time, taaf_all_on(:, 2), 'k', 'LineWidth', 1);
