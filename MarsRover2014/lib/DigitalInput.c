/*
 *   DigitalInput.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        uint8 y1 = readInput(uint8 p1)
 *
 *   Simulink version           : 8.3 (R2014a) 27-Dec-2013
 *   C source code generated on : 21-Mar-2014 17:03:03
...
/*
   ...
   def.SFunctionName = 'DigitalInput';
   def.OutputFcnSpec = 'uint8 y1 = readInput(uint8 p1)';
   def.StartFcnSpec = 'void initDigitalInput(uint8 p1,uint8 p2)';
 ...
 */
#define S_FUNCTION_NAME                DigitalInput
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "initDigitalInput", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

    /*
     * Register reserved identifier for OutputFcnSpec
     */
    ssRegMdlInfo(S, "readInput", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
