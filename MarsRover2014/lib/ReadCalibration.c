/*
 *   ReadCalibration.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        void read_calibration_matrix(single y1[9])
 *
 *   Simulink version           : 8.3 (R2014a) 27-Dec-2013
 *   C source code generated on : 05-Jun-2014 15:37:34
 ...
 */
#define S_FUNCTION_NAME                ReadCalibration
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "read_calibration_matrix", MDL_INFO_ID_RESERVED, 0, 0,
                 ssGetPath(S));
  }
