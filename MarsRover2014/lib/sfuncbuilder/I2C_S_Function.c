 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Fri Jun  6 10:34:39 2014
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME I2C_S_Function
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void I2C_S_Function_Outputs_wrapper(const uint8_T *u0,
			uint8_T *y0,
			const real_T *xD,
			const uint8_T  *Par, const int_T  p_width0);
extern void I2C_S_Function_Update_wrapper(const uint8_T *u0,
			const uint8_T *y0,
			real_T *xD,
			const uint8_T  *Par,  const int_T  p_width0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const uint8_T  *Par  = (const uint8_T *)mxGetData(PARAM_DEF0(S));


    I2C_S_Function_Outputs_wrapper(u0, y0, xD, Par, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    I2C_S_Function_Update_wrapper(u0, y0,  xD, Par, p_width0);
}
