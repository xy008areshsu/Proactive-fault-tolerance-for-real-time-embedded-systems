...
## Generated on : Thu Apr 09 10:34:10 2015
## MATLAB Coder version: 2.8 (R2015a)
## 
## Build Info:
## 
## Final product: InputProcessing.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR)/InputProcessing_ert_rtw -I$(START_DIR) -ID:/Dropbox/Phd/AutomaticScriptForSubRegions/MarsRover2014/model -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/CMSIS/CMSIS/Include -IC:/MATLAB/SupportPackages/R2015a/armcortexm/toolbox/target/supportpackages/arm_cortex_m/@slCustomizer/../include -I$(MATLAB_ROOT)/toolbox/rtw/targets/pil/c -I$(START_DIR)/InputProcessing_ert_rtw/pil -I$(MATLAB_ROOT)/extern/include/coder/connectivity/xilservice -I$(MATLAB_ROOT)/extern/include/coder/connectivity/xilservice/target -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/extern/include/coderprofile/codeinstr_service -IC:/MATLAB/SupportPackages/R2015a/armcortexm/toolbox/target/supportpackages/arm_cortex_m/include
...
DEFINES_ = -DMODEL=InputProcessing -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -DRTIOSTREAM_RX_BUFFER_BYTE_SIZE=128 -DRTIOSTREAM_TX_BUFFER_BYTE_SIZE=128 -DCODE_INSTRUMENTATION_ENABLED=1 -DMEM_UNIT_BYTES=1 -DMemUnit_T=uint8_T
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_interface_lib.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_data_stream.c $(START_DIR)/InputProcessing_ert_rtw/pil/xil_interface.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xilcomms_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c C:/MATLAB/SupportPackages/R2015a/armcortexm/toolbox/target/supportpackages/arm_cortex_m/src/rtiostream_serial.c C:/MATLAB/SupportPackages/R2015a/armcortexm/toolbox/target/supportpackages/arm_cortex_m/src/pil_main.c C:/MATLAB/SupportPackages/R2015a/armcortexm/toolbox/target/supportpackages/arm_cortex_m/src/startup_gcc.c C:/MATLAB/SupportPackages/R2015a/armcortexm/toolbox/target/supportpackages/arm_cortex_m/src/system_LM3S.c C:/MATLAB/SupportPackages/R2015a/armcortexm/toolbox/target/supportpackages/arm_cortex_m/src/syscalls.c $(START_DIR)/InputProcessing_ert_rtw/pil/xil_instrumentation.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/codeinstr_data_stream.c C:/MATLAB/SupportPackages/R2015a/armcortexm/toolbox/target/supportpackages/arm_cortex_m/src/profiler_timer.c
...
PREBUILT_OBJS = ../instrumented/InputProcessing.o ../instrumented/InputProcessing_data.o ../instrumented/rtGetInf.o ../instrumented/rtGetNaN.o ../instrumented/rt_nonfinite.o
...
%.o : $(START_DIR)/InputProcessing_ert_rtw/pil/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/InputProcessing_ert_rtw/pil/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/InputProcessing_ert_rtw/pil/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/InputProcessing_ert_rtw/pil/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/InputProcessing_ert_rtw/pil/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
