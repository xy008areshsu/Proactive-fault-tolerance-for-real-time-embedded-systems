...
#define taskTimeStart_Controller_offset 0
#define taskTimeEnd_Controller_offset  0
...
{
  taskTimeStart(taskTimeStart_Controller_offset + sectionId);
}

void taskTimeEnd_Controller(uint32_T sectionId)
{
  taskTimeEnd(taskTimeEnd_Controller_offset + sectionId);
}
