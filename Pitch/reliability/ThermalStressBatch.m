...
%% Batch Job
for w = watts
    [taaf_all_on(:, i), T_abs_all_on(:, i)] = ThermalStressAllOnFunc( R, C, initTabs, Tamb, Ea, w,  watt_idle, k, A, step, time);
%     [taaf_adaptive(:, i), T_abs_adaptive(:,i)] = ThermalStreeAdaptiveFunc(R, C, initTabs, Tamb, Ea, w, watt_idle, k, A, step, time);
    [taaf_adaptive1(:, i), T_abs_adaptive1(:,i), taaf_adaptive2(:, i), T_abs_adaptive2(:, i), taaf_adaptive3(:, i), T_abs_adaptive3(:, i)] = ThermalStreeAdaptiveFuncWithRegions(R, C, initTabs, Tamb, Ea, w, watt_idle, k, A, step, time, t_S_N, t_S_FS);
    i = i + 1;
end
...
% saveas(gcf, './reliability_results/TAAF_Adaptive1', 'pdf') %Save figure
...
% set(gcf, 'PaperPosition', [0 0 5 5]); %Position plot at left hand corner with width 5 and height 5.
% set(gcf, 'PaperSize', [5 5]); %Set the paper to have width 5 and height 5.
% saveas(gcf, './reliability_results/TAAF_Adaptive2', 'pdf') %Save figure
...
% set(gcf, 'PaperPosition', [0 0 5 5]); %Position plot at left hand corner with width 5 and height 5.
% set(gcf, 'PaperSize', [5 5]); %Set the paper to have width 5 and height 5.
% saveas(gcf, './reliability_results/TAAF_Adaptive3', 'pdf') %Save figure
...
% set(gcf, 'PaperPosition', [0 0 5 5]); %Position plot at left hand corner with width 5 and height 5.
% set(gcf, 'PaperSize', [5 5]); %Set the paper to have width 5 and height 5.
% saveas(gcf, './reliability_results/TAAF_All_on', 'pdf') %Save figure
...
% set(gcf, 'PaperPosition', [0 0 5 5]); %Position plot at left hand corner with width 5 and height 5.
% set(gcf, 'PaperSize', [5 5]); %Set the paper to have width 5 and height 5.
% saveas(gcf, './reliability_results/TAAF_all_in_one_plot', 'pdf') %Save figure
